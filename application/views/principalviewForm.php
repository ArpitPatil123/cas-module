...
<body>
    ...
    <div class="container mt-4 d-grid gap-2 d-md-flex justify-content-center mb-4">
        <?php if ($row->status == '0') : ?>
        <a class="btn btn-success" style="width:125px;" type="button"
            href="<?= base_url('formcontroller/updateStatus/' . $row->Id . '/' . $row->Email); ?>">Approve</a>
        ...
        <a class="btn btn-danger" style="width:125px;" type="button"
            href="<?= base_url('formcontroller/revertPrincipal/' . $row->Id) ?>">Revert</a>
        <?php endif ?>
    </div>
