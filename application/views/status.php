                        ...
                        <table class="table table-hover bdr">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="button" class="btn btn-sm btn-primary" id="view_status"
                                            value="View Status">
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-body1">
                                            ...
                                            <h5 class="formStatusheading"> Form Status <h5>
                                                    ...
                                                    <div class="container mt-4">
                                                        <h1 class="text-danger w-50" style="margin-left: -80px;">
                                                            Rejected!</h1>
                                                        <h5>Reason : <?= $row->text; ?></h5>
                                                        <button class="btn btn-sm btn-danger"><a
                                                                href="<?= base_url('formcontroller/index'); ?>"
                                                                class="text-white">Re-Apply</a></button>
                                                    </div>
                                                    <?php endif ?>
                                        </div>
                                    </div>
