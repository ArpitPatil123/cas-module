    ...
    <div class="card pt-4 mb-3">
        ...
        <div id="msform">
            ...
            <fieldset>
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4" id="Middlename">
                        ...
                        <input type="text" class="form-control" id="middlename" name="Middlename"
                            placeholder="Middlename" value="<?= set_value('Middlename') ?>">
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <button type="button" class="btn btn-primary" id="send"
                            style="display: block;margin-top:10px;">Send Otp</button>

                        <label for="verified" class="form-label"></label>
                        <button type="button" class="btn btn-success" id="verified"
                            style="display: none;margin-top:10px;">Verified <i class="fa fa-check-circle"
                                aria-hidden="true"></i> </button>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="verify" class="form-label"></label>
                        <button type="button" class="btn btn-primary" value="Verify Otp" id="verify"
                            style="display: none;margin-top:10px;">Verify Otp</button>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-select" name="Designation" aria-label="Default select example" id="branch">
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="dob" name="DOB" placeholder="Date Of Birth"
                            value="<?= set_value('DOB') ?>" max="2000-12-31">
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4">
                        <label for="employeecode" class="form-label">Sevarth Id<span style="color: darkred;">
                                *</span></label>
                        <input type="text" class="form-control" id="employeecode" name="EmployeeCode"
                            placeholder="Sevarth Id" value="<?= set_value('EmployeeCode') ?>">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-select" name="Branch" aria-label="Default select example" id="branch">
                            value="<?= set_value('Branch') ?>">
                            <option value>--Select--</option>
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-4">
                        <label for="exampleInputPassword2" class="form-label">Address<span style="color: darkred;">
                                *</span></label>
                        <textarea name="Address" placeholder="Address" id="address"
            ...
            <fieldset>
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-6">
                        <label for="dop" class="form-label">Date of Probession<span style="color: darkred;">
                                *</span></label>
                        <input type="date" class="form-control" id="dop" name="Probession" placeholder="Probession Date"
                            value="<?= set_value('Probession') ?>">
                        <span class="text-danger"><?= form_error('Probession'); ?></span>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="gr" class="form-label">GR No<span style="color: darkred;"> *</span></label>
                        <input type="text" class="form-control" id="gr" name="GRNo" placeholder="Gr No."
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-4">
                        <label for="insname" class="form-label">Institute Name<span style="color: darkred;">
                                *</span></label>
                        <input type="text" class="form-control" id="insname" name="InstituteName[]"
                            placeholder="Institute Name">
                        <span class="text-danger"><?= form_error('InstituteName[]'); ?></span>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="ssd" class="form-label">Service Start Date<span style="color: darkred;">
                                *</span></label>
                        <input type="date" class="form-control" id="ssd" name="ServiceStartDate[]"
                            placeholder="Service Start Date">
                        <span class="text-danger"><?= form_error('ServiceStartDate[]'); ?></span>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="sed" class="form-label">Service End Date<span style="color: darkred;">
                                *</span></label>
                        <input type="date" class="form-control" id="sed" name="ServiceEndDate[]"
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-6">
                        <label for="upload" class="form-label">Upload Proof Here<span style="color: darkred;">
                                *</span></label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4">
                        <label for="trainingname" class="form-label">Training Name<span style="color: darkred;">
                                *</span></label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="sponsoredby" class="form-label">Sponsored By<span style="color: darkred;">
                                *</span></label>
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-select" name="Duration[]" aria-label="Default select example" id="gender">
                            <option value>--Select--</option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="sd" name="StartDate[]"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="ed" name="EndDate[]"
            ...
            <fieldset>
                ...
                <div class="row mb-4">
                    <div class="form-group col-md-4">
                        <label for="cred" class="form-label">CR Start Date<span style="color: darkred;">
                                *</span></label>
                        <input type="date" class="form-control" id="crsd" name="CRStartDate[]">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="cred" name="CREndDate[]">
                        <span class="text-danger"><?= form_error('CRStartDate[]'); ?></span>
                    </div>
                    <div class="form-group col-md-4">
